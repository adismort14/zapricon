...
def profile_view(request, username):
    ...
    return render(
        request, "accounts/profile_page.html", {"user": user, "follow": follow}
    )
    ...
    if request.method == "POST":
        ...
        if edit_form.is_valid():
            ...
            return HttpResponseRedirect(
                reverse_lazy("accounts:profile", kwargs={"username": user.username})
            )
...
def follow_view(request, username):
    ...
    return HttpResponseRedirect(
        reverse_lazy("accounts:profile", kwargs={"username": username})
    )
...
def accounts_home(request):
    ...
    return render(
        request,
        "accounts/home.html",
        {"users": suggested_users, "type_of_users": type_of_users},
    )
...
def followers(request):
    ...
    return render(
        request,
        "accounts/home.html",
        {"users": follower_users, "type_of_users": type_of_users},
    )
...
def following(request):
    ...
    return render(
        request,
        "accounts/home.html",
        {"users": following_users, "type_of_users": type_of_users},
    )
